...
$string['block_panopto_print_log_to_file_desc'] = 'When this setting is enabled, Panopto logs that would normally go to the PHP error_log will be redirected to a file called "PanoptoLogs.txt" in the Moodle data directory. The location of this directory is defined by $CFG->dataroot in the site config.php file. This should only be enabled if advised by Panopto Support.';
